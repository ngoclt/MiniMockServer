#
#  Be sure to run `pod spec lint MiniMockServer.podspec' to ensure this is a
...
MiniMockServer is a Swift framework which provides a very simple solution to stub network requests for UI/Integration tests on iOS.
  ...
  spec.author             = "Ngoc Le"
  spec.social_media_url   = "https://coder.life/"
  ...
  spec.source       = { :git => "https://github.com/ngoclt/MiniMockServer.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "MiniMockServer/**/*.{swift}"
